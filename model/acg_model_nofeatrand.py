...
def define_clfs_params():
    ...
    params = { 
        'RF':{'n_estimators': [1,10,100,1000], 'max_depth': [1,3,5,10,15,25, 30, 40, 50], 'max_features': ['sqrt','log2'],'min_samples_split': [2,5,10]},
        'LR': {'penalty': ['l1','l2'], 'C': [0.00001,0.0001,0.001,0.01,0.1,1,10]},
        'SGD': {'loss': ['log','perceptron'], 'penalty': ['l2','l1','elasticnet']},
        'ET': {'n_estimators': [1,10,100,1000], 'criterion' : ['gini', 'entropy'] ,'max_depth': [1,3,5,10,15,25, 30, 40, 50], 'max_features': ['sqrt','log2'],'min_samples_split': [2,5,10]},
        ...
        'NB' : {},
        'DT': {'criterion': ['gini', 'entropy'], 'max_depth': [1,3,5,10,15,25, 30, 40, 50], 'max_features': ['sqrt','log2'],'min_samples_split': [2,5,10]},
