...
def define_clfs_params():
    ...
    params = { 
        'RF':{'n_estimators': [1,10,100,1000], 'max_depth': [1,3,5,10,15], 'max_features': ['sqrt','log2'],'min_samples_split': [2,5,10]},
        ...
        'NB' : {},
        'DT': {'criterion': ['gini', 'entropy'], 'max_depth': [1,3,5,10,15], 'max_features': ['sqrt','log2'],'min_samples_split': [2,5,10]},
