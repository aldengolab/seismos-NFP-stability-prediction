...
def define_project_params():
    ...
    '''
    models_to_run = ['RF'] # Use this to specify the model type
...
def define_clfs_params():
    ...
    params = {
        'RF': {'n_estimators': [1000], 'max_depth': [100], 'max_features': ['sqrt'], 'min_samples_split': [5], 'random_state': [1]},
